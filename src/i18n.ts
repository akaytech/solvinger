...
const resources = {
  ...
  es: {
    translation: {
      ...
      "go_to_root": "Ir al Objetivo Raíz",
      ...
      "add_subgoal": "Añadir Subobjetivo",
  ...
  fr: {
    translation: {
      ...
      "go_to_root": "Aller à l'objectif principal",
      ...
      "add_subgoal": "Ajouter un Sous-objectif",
  ...
  de: {
    translation: {
      ...
      "add_subgoal": "Teilziel hinzufügen",
  ...
  pt: {
    translation: {
      ...
      "go_to_root": "Ir para Objetivo Raiz",
      ...
      "add_subgoal": "Adicionar Subobjetivo",
  ...
  ru: {
    translation: {
      ...
      "go_to_root": "Перейти к главной цели",
  ...
  ar: {
    translation: {
      ...
      "go_to_root": "الذهاب للهدف الرئيسي",
      "my_projects": "مشاريعي",
