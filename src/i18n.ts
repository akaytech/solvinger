...
export const resources = {
  "ar": {
    "translation": {
      ...
      "fta_add_conditioning": "Conditioning Event",
      "fta_add_priority_and": "Priority AND Gate",
      "fta_add_xor": "Exclusive OR (XOR)",
      "fta_add_inhibit": "Inhibit Gate",
      "fta_prob_input": "Probability (%):",
      "fta_events": "EVENTS",
      "fta_gates": "LOGIC GATES",
  ...
  "de": {
    "translation": {
      ...
      "wf_lld_desc": "Detaillieren Sie physische Designspezifikationen, Hardware- und Softwaretechnologien.",
      "wf_complete_phase": "Phase abschließen und fortfahren",
      "wf_phase_locked": "Diese Phase ist derzeit gesperrt.",
      "wf_phase_completed": "Phase Abgeschlossen",
      "wf_req_locked": "Anforderungen sind abgeschlossen und können nicht mehr geändert werden.",
      ...
      "req": "1. Anforderungen",
      "des": "2. Design",
      "imp": "4. Implementierung",
      "ver": "5. Überprüfung (Testen)",
      "mai": "6. Wartung",
  ...
  "en": {
    "translation": {
      ...
      "wf_lld_desc": "Detail the physical design specs, hardware, and software technologies.",
      "wf_complete_phase": "Complete Phase and Continue",
      "wf_phase_locked": "This phase is currently locked.",
      "wf_phase_completed": "Phase Completed",
      "wf_req_locked": "Requirements are completed and cannot be modified.",
      "tool_eod": "EOD Planner",
      "eod_title": "EOD Planner",
  ...
  "es": {
    "translation": {
      ...
      "wf_lld_desc": "Detalle las especificaciones de diseño físico, hardware y tecnologías de software.",
      "wf_complete_phase": "Completar Fase y Continuar",
      "wf_phase_locked": "Esta fase está bloqueada actualmente.",
      "wf_phase_completed": "Fase Completada",
      "wf_req_locked": "Los requisitos están completos y no se pueden modificar.",
      "tool_eod": "EOD Planner",
      "eod_title": "EOD Planner",
      ...
      "req": "1. Requisitos",
      "des": "2. Diseño",
      "imp": "4. Implementación",
      "ver": "5. Verificación (Pruebas)",
      "mai": "6. Mantenimiento",
  ...
  "fr": {
    "translation": {
      ...
      "wf_lld_desc": "Détaillez les spécifications de conception physique, le matériel et les technologies logicielles.",
      "wf_complete_phase": "Terminer la Phase et Continuer",
      "wf_phase_locked": "Cette phase est actuellement verrouillée.",
      "wf_phase_completed": "Phase Terminée",
      "wf_req_locked": "Les exigences sont terminées et ne peuvent plus être modifiées.",
      "tool_eod": "EOD Planner",
      "eod_title": "EOD Planner",
  ...
  "tr": {
    "translation": {
      ...
      "fta_add_conditioning": "Koşul Olayı",
      "fta_add_priority_and": "Priority AND Kapısı",
      "fta_add_xor": "Exclusive OR (XOR)",
      "fta_add_inhibit": "Inhibit Kapısı",
      "fta_prob_input": "Olasılık (%):",
      "fta_events": "OLAYLAR",
      "fta_gates": "MANTIK KAPILARI",
      "export_image": "İndir",
      ...
      "wf_lld_desc": "Donanım, yazılım teknolojileri ve fiziksel tasarım spesifikasyonlarını detaylandırın.",
      "wf_complete_phase": "Bu Aşamayı Tamamla ve Sonrakine Geç",
      "wf_phase_locked": "Bu aşama şu an kilitli.",
      "wf_phase_completed": "Aşama Tamamlandı",
      "wf_req_locked": "Gereksinimler tamamlandı, değiştirilemez.",
      "tool_eod": "EOD Planner",
      "eod_title": "EOD Planner",
      ...
      "des": "2. Tasarım",
      "imp": "4. Uygulama (Geliştirme)",
      "ver": "5. Test (Doğrulama)",
      "mai": "6. Bakım",
