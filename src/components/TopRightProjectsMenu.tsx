        ...
        <div className="flex flex-col ps-6 pe-2 space-y-0.5 mt-1">
          {(project.nodes?.length > 0) && (
            <div className="group/tool relative">
              <button onClick={() => handleToolClick('wbs')} className="flex w-full items-center gap-2 text-xs font-medium text-slate-600 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-slate-50 dark:hover:bg-slate-800 p-1.5 rounded-lg transition-colors pe-8">
              ...
              <button 
                ...
                className="absolute end-1 top-1/2 -translate-y-1/2 p-1 text-slate-400 hover:text-red-500 transition-opacity opacity-40 group-hover/tool:opacity-100" title={t('delete_title')} aria-label={t('delete_title')}
          ...
          {(project.swot?.length > 0) && (
             <div className="group/tool relative">
               <button onClick={() => handleToolClick('swot')} className="flex w-full items-center justify-between text-xs font-medium text-slate-600 dark:text-slate-400 hover:text-amber-600 dark:hover:text-amber-400 hover:bg-amber-50/50 dark:hover:bg-amber-900/20 p-1.5 rounded-lg transition-colors pe-[52px]">
          ...
          {((project.fiveWhysNodes?.length ?? 0) > 1) && (
             <div className="group/tool relative">
               <button onClick={() => handleToolClick('5whys')} className="flex w-full items-center justify-between text-xs font-medium text-slate-600 dark:text-slate-400 hover:text-rose-600 dark:hover:text-rose-400 hover:bg-rose-50/50 dark:hover:bg-rose-900/20 p-1.5 rounded-lg transition-colors pe-6">
                 <div className="flex items-center gap-2">
          ...
          {(project.ishikawa?.length > 0) && (
             <div className="group/tool relative">
               <button onClick={() => handleToolClick('ishikawa')} className="flex w-full items-center justify-between text-xs font-medium text-slate-600 dark:text-slate-400 hover:text-cyan-600 dark:hover:text-cyan-400 hover:bg-cyan-50/50 dark:hover:bg-cyan-900/20 p-1.5 rounded-lg transition-colors pe-[52px]">
                 <div className="flex items-center gap-2">
          ...
          {(project.pdca?.length > 0) && (
             <div className="group/tool relative">
               <button onClick={() => handleToolClick('pdca')} className="flex w-full items-center justify-between text-xs font-medium text-slate-600 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400 hover:bg-emerald-50/50 dark:hover:bg-emerald-900/20 p-1.5 rounded-lg transition-colors pe-[52px]">
                 <div className="flex items-center gap-2">
          ...
          {(project.ftaNodes?.length ?? 0) > 1 && (
             <div className="group/tool relative">
               <button onClick={() => handleToolClick('fta')} className="flex w-full items-center justify-between text-xs font-medium text-slate-600 dark:text-slate-400 hover:text-rose-600 dark:hover:text-rose-400 hover:bg-rose-50/50 dark:hover:bg-rose-900/20 p-1.5 rounded-lg transition-colors pe-6">
                 <div className="flex items-center gap-2">
          ...
          {(project.waterfall?.length > 0) && (
             <div className="group/tool relative">
               <button onClick={() => handleToolClick('waterfall')} className="flex w-full items-center justify-between text-xs font-medium text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50/50 dark:hover:bg-blue-900/20 p-1.5 rounded-lg transition-colors pe-[52px]">
                 <div className="flex items-center gap-2">
          ...
          {((project.decision?.length ?? 0) > 0) && (
             <div className="group/tool relative">
               <button onClick={() => handleToolClick('decision')} className="flex w-full items-center justify-between text-xs font-medium text-slate-600 dark:text-slate-400 hover:text-violet-600 dark:hover:text-violet-400 hover:bg-violet-50/50 dark:hover:bg-violet-900/20 p-1.5 rounded-lg transition-colors pe-[52px]">
                 <div className="flex items-center gap-2">
           ...
           {((project.flowchartNodes?.length ?? 0) > 1) && (
             <div className="group/tool relative">
               <button onClick={() => handleToolClick('flowchart')} className="flex w-full items-center justify-between text-xs font-medium text-slate-600 dark:text-slate-400 hover:text-amber-600 dark:hover:text-amber-400 hover:bg-amber-50/50 dark:hover:bg-amber-900/20 p-1.5 rounded-lg transition-colors pe-6">
                 <div className="flex items-center gap-2">
          ...
          {((project.pareto?.length ?? 0) > 0) && (
             <div className="group/tool relative">
               <button onClick={() => handleToolClick('pareto')} className="flex w-full items-center justify-between text-xs font-medium text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50/50 dark:hover:bg-blue-900/20 p-1.5 rounded-lg transition-colors pe-[52px]">
                 <div className="flex items-center gap-2">
           ...
           {((project.histogram?.length ?? 0) > 0) && (
             <div className="group/tool relative">
               <button onClick={() => handleToolClick('histogram')} className="flex w-full items-center justify-between text-xs font-medium text-slate-600 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50/50 dark:hover:bg-indigo-900/20 p-1.5 rounded-lg transition-colors pe-[52px]">
                 <div className="flex items-center gap-2">
          ...
          {((project.notepad?.length ?? 0) > 0) && (
             <div className="group/tool relative">
               <button onClick={() => handleToolClick('notepad')} className="flex w-full items-center justify-between text-xs font-medium text-slate-600 dark:text-slate-400 hover:text-fuchsia-600 dark:hover:text-fuchsia-400 hover:bg-fuchsia-50/50 dark:hover:bg-fuchsia-900/20 p-1.5 rounded-lg transition-colors pe-[52px]">
                 <div className="flex items-center gap-2">
          ...
          {((project.eod?.length ?? 0) > 0) && (
             <div className="group/tool relative">
               <button onClick={() => handleToolClick('eod')} className="flex w-full items-center justify-between text-xs font-medium text-slate-600 dark:text-slate-400 hover:text-orange-600 dark:hover:text-orange-400 hover:bg-orange-50/50 dark:hover:bg-orange-900/20 p-1.5 rounded-lg transition-colors pe-[52px]">
                 <div className="flex items-center gap-2">
...
export default function TopRightProjectsMenu() {
  ...
  return (
    ...
    >
      ...
      <div 
        className={`absolute top-14 end-0 w-80 origin-top-right rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-2 shadow-2xl transition-all duration-300 ${isOpen ? 'scale-100 opacity-100' : 'scale-95 opacity-0 pointer-events-none'}`}
      >
