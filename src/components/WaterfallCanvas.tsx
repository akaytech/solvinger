...
export default function WaterfallCanvas() {
  ...
  const PHASES: { id: WaterfallPhase; title: string; icon: any; color: string; bg: string; border: string; buttonBg: string; desc: string; indent: string }[] = [
    ...
    { id: 'Design', title: t('des'), icon: PenTool, color: 'text-purple-600 dark:text-purple-400', bg: 'bg-purple-50 dark:bg-purple-900/20', border: 'border-purple-200 dark:border-purple-900/50', buttonBg: 'bg-purple-600 hover:bg-purple-700', desc: t('des_desc'), indent: 'ml-0 md:ml-12' },
    { id: 'Implementation', title: t('imp'), icon: Code, color: 'text-blue-600 dark:text-blue-400', bg: 'bg-blue-50 dark:bg-blue-900/20', border: 'border-blue-200 dark:border-blue-900/50', buttonBg: 'bg-blue-600 hover:bg-blue-700', desc: t('imp_desc'), indent: 'ml-0 md:ml-24' },
    { id: 'Verification', title: t('ver'), icon: CheckSquare, color: 'text-amber-600 dark:text-amber-400', bg: 'bg-amber-50 dark:bg-amber-900/20', border: 'border-amber-200 dark:border-amber-900/50', buttonBg: 'bg-amber-600 hover:bg-amber-700', desc: t('ver_desc'), indent: 'ml-0 md:ml-36' },
