...
export default function ToolHeader({ title, subtitle, icon, iconColor = 'text-indigo-500', dividerOnTop = false, children }: ToolHeaderProps) {
  ...
  return (
    <div className="flex-none pt-20 pb-6 ps-16 pe-24 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm z-10 flex justify-between items-center">
      <div>
