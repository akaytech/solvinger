...
export default function ContextMenu({
  ...
  return (
    ...
    >
      ...
      <div className="px-3 py-1.5 text-xs font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500">Durum Değiştir</div>
      ...
      >
        <CheckCircle size={18} className="text-slate-400 dark:text-slate-500" /> Yapılacak
      </button>
      <button
      ...
      >
        <CheckCircle size={18} className="text-emerald-500 dark:text-emerald-400" /> Devam Ediyor
      </button>
      <button
      ...
      >
        <CheckCircle size={18} className="text-indigo-500 dark:text-indigo-400" /> Tamamlandı
      </button>
      <button
      ...
      >
        <XCircle size={18} className="text-red-500 dark:text-red-400" /> Başarısız
      </button>
